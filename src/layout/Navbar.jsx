...
export default function Navbar({ showSidebar, setShowSidebar }) {
  ...
  return (
    <nav className="dark:bg-[#1C1C25] md:ml-[15.2rem] py-[19.5px] pl-[39px] pr-[37px] bg-[#CAF0F8]">
      <div className="container max-w-full mx-auto flex items-center justify-between bg-[#CAF0F8] dark:bg-[#1C1C25]">
        <div className="md:hidden bg-[#CAF0F8] dark:bg-[#1C1C25]">
          ...
          <div
            className={`absolute top-2 md:hidden bg-[#CAF0F8] ${
